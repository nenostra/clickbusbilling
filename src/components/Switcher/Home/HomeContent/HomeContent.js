...
const HomeContent = () => (
  <div className="HomeContent">
    <p className="HomeContent-welcome" >Bienvenido(a) al portal de Facturación Electrónica de ClickBus México</p>
    <p className="HomeContent-process" >El proceso de facturación de boletos de autobús adquiridos a través de ClickBus
