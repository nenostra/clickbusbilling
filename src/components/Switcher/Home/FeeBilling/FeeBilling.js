...
const FeeBilling = () => (
  <div className="FeeBilling">
    <div className="FeeBilling-title">
      <img src={feeBillingIcon} alt="fee-billing-icon"/>
      <span className="FeeBilling-title-text">Facturación de tasa de servicio</span>
    </div>
    <div className="FeeBilling-list">
      <p className="FeeBilling-list-title">Aquí podrá</p>
      <ul>
    ...
    <div className="FeeBilling-list">
      <p className="FeeBilling-list-title">Consideraciones</p>
      <ul>
        <li className="FeeBilling-list-dot">
          <p className="FeeBilling-list-element-content">
